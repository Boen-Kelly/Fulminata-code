...
public class Mecanum_drive_test extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive()) {
            ...
            backLeftWheel.setPower(forward + strafe + rotation);
            backRightWheel.setPower(forward - strafe + rotation);
            frontLeftWheel.setPower(forward + strafe - rotation);
            frontRightWheel.setPower(forward - strafe - rotation);
